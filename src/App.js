 ...
 function AboutZeon() {
  return (<div className="min-h-screen bg-base-300">
    ...
    <div >
      ...
      <p className="py-6 flex-wrap text-wrap max-w-md">Zeon orignally  started out as a discord bot then continued to develop and got expanded to github to work on my repos as an app. </p>
    ...
    <div className='text-right place-items-end'>
      ...
      <p className="py-6 text-right text-wrap max-w-md">Zeon runs his mangment through github linting, and organizing my code on my repositorys to make sure there good. Zeon also currently runs my depoloyments running them through either the application or gh workflows under his token.</p>
...
function CardDisplay({ title, description, buttons }) {
  return (
    <ScrollAnimation animateIn="fadeIn">
    <div className="card md:w-96 w-60 bg-base-100 hover:bg-base-50 text-primary-content duration-700 transform md:hover:scale-125 md:m-5 md:float-none float-end mb-10 mr-20">        
